...
public class DiceSet {
   ...
   public DiceSet( int count, int sides ) {
     // ds = new Die[ count ];
      if (count <= 0){
        ...
        System.out.println("Please put more than 0 die to play this game");
        System.exit(0);
      }
      this.count = count;
      this.sides = sides;
      this.ds = new Die[count]; // contrusts an empty array we have to loop 
   ...
   */
   public int rollIndividual( int dieIndex ) {
      ...
      }else if (dieIndex > count - 1 ) {
        throw new IllegalArgumentException("Must be less than four");
   ...
   */
      ...
      System.out.print( "should get true:" ); 
      try { DiceSet d = new DiceSet(5, 9); System.out.println( d.rollIndividual(0) <= d.sides ? "true" : "false" );}                                  
      catch( Exception e ) { System.out.println ( " number can't be used" ); }
